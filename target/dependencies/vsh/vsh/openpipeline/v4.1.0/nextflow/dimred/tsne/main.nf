...
meta = [
  ...
  "build_info" : {
    "config" : "/workdir/root/repo/src/dimred/tsne/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker|native",
    "output" : "/workdir/root/repo/target/nextflow/dimred/tsne",
    "viash_version" : "0.9.7",
...
par = {
  ...
  'use_rep': $( if [ ! -z ${VIASH_PAR_USE_REP+x} ]; then echo "r'${VIASH_PAR_USE_REP//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  ...
  'perplexity': $( if [ ! -z ${VIASH_PAR_PERPLEXITY+x} ]; then echo "float(r'${VIASH_PAR_PERPLEXITY//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    ...
    "image" : "vsh/openpipeline/dimred/tsne",
    "tag" : "v4.1.0"
  },
  "label" : [
    "highcpu",
