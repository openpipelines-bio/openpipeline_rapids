// neighbors_leiden_umap build_main
// 
...
meta = [
  ...
  "description" : "Performs neighborhood search, Leiden clustering and UMAP on an integrated\nembedding, running either the GPU (rapids-singlecell) or the CPU (scanpy)\nvariant of the whole workflow, selected with --device_type.\n",
  "test_resources" : [
    {
      "type" : "nextflow_script",
      "path" : "test.nf",
  ...
  "dependencies" : [
    {
      ...
      "alias" : "neighbors_leiden_umap_gpu",
      "repository" : {
        "type" : "local"
      }
    },
    {
      "name" : "workflows/multiomics/neighbors_leiden_umap",
      "alias" : "neighbors_leiden_umap_cpu",
      "repository" : {
        "type" : "vsh",
        "repo" : "openpipeline",
        "tag" : "v4.1.0"
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_rapids/openpipeline_rapids/src/wrappers/multiomics/neighbors_leiden_umap/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
    "output" : "/home/runner/work/openpipeline_rapids/openpipeline_rapids/target/_private/nextflow/wrappers/multiomics/neighbors_leiden_umap",
    "viash_version" : "0.9.7",
...
include { neighbors_leiden_umap as neighbors_leiden_umap_gpu_viashalias } from "${meta.resources_dir}/../../../../../nextflow/workflows/multiomics/neighbors_leiden_umap/main.nf"
neighbors_leiden_umap_gpu = neighbors_leiden_umap_gpu_viashalias.run(key: "neighbors_leiden_umap_gpu")
include { neighbors_leiden_umap as neighbors_leiden_umap_cpu_viashalias } from "${meta.root_dir}/dependencies/vsh/vsh/openpipeline/v4.1.0/nextflow/workflows/multiomics/neighbors_leiden_umap/main.nf"
neighbors_leiden_umap_cpu = neighbors_leiden_umap_cpu_viashalias.run(key: "neighbors_leiden_umap_cpu")
