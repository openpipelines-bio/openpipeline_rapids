...
meta = [
  ...
  "argument_groups" : [
    {
      ...
      "arguments" : [
        ...
        },
        {
          "type" : "string",
          "name" : "--obsm_input",
          "description" : "The `.obsm` slot to use as the representation to embed.",
          "default" : [
            "X_pca"
          ],
          "required" : false,
        ...
        },
        {
          "type" : "integer",
          "name" : "--n_pcs",
          "description" : "The number of dimensions of the representation to use. If not set,\nall dimensions of `--obsm_input` are used.\n",
          "required" : false,
          "min" : 1,
          "direction" : "input",
          "multiple" : false,
    ...
    },
    {
      ...
      "arguments" : [
        ...
        },
        {
          "type" : "string",
          "name" : "--obsm_output",
          "description" : "In which .obsm slot to store the resulting t-SNE embedding.",
          "default" : [
            "X_tsne"
          ],
          "required" : false,
    ...
    },
    {
      ...
      "arguments" : [
        ...
        },
        {
          "type" : "double",
          "name" : "--learning_rate",
          "description" : "The learning rate for the optimization. If the learning rate is too\nhigh, the data may look like a 'ball' with any point approximately\nequidistant from its nearest neighbours. If it is too low, most\npoints may look compressed in a dense cloud with few outliers.\n",
          "default" : [
            200.0
          ],
          "required" : false,
        ...
        },
        {
          "type" : "string",
          "name" : "--metric",
          "description" : "The metric to use when computing distances in the representation.",
          "default" : [
            "euclidean"
          ],
          "required" : false,
    ...
    },
    {
      ...
      "arguments" : [
        ...
        },
        {
          "type" : "string",
          "name" : "--method",
          "description" : "The t-SNE method to use.",
          "default" : [
            "barnes_hut"
          ],
          "required" : false,
    ...
    },
    {
      ...
      "arguments" : [
        ...
        },
        {
          "type" : "integer",
          "name" : "--random_state",
          "description" : "The random seed to use for the t-SNE computation.",
          "default" : [
            0
          ],
          "required" : false,
  ...
  "description" : "Compute a t-SNE embedding, running either the GPU (rapids-singlecell) or the\nCPU (scanpy) variant of tsne, selected with --device_type.\n",
  "test_resources" : [
    {
      "type" : "nextflow_script",
      "path" : "test.nf",
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_rapids/openpipeline_rapids/src/wrappers/tools/tsne/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
...
include { tsne as tsne_gpu_viashalias } from "${meta.resources_dir}/../../../../../nextflow/tools/tsne/main.nf"
tsne_gpu = tsne_gpu_viashalias.run(key: "tsne_gpu")
include { tsne as tsne_cpu_viashalias } from "${meta.root_dir}/dependencies/vsh/vsh/openpipeline/v4.1.0/nextflow/dimred/tsne/main.nf"
tsne_cpu = tsne_cpu_viashalias.run(key: "tsne_cpu")
