...
meta = [
  ...
  "description" : "UMAP (Uniform Manifold Approximation and Projection), running either the GPU\n(rapids-singlecell) or the CPU (scanpy/squidpy) variant, selected with --device_type.\n",
  "test_resources" : [
    {
      "type" : "nextflow_script",
      "path" : "test.nf",
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_rapids/openpipeline_rapids/src/wrappers/tools/umap/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
...
include { umap as umap_gpu_viashalias } from "${meta.resources_dir}/../../../../../nextflow/tools/umap/main.nf"
umap_gpu = umap_gpu_viashalias.run(key: "umap_gpu")
include { umap as umap_cpu_viashalias } from "${meta.root_dir}/dependencies/vsh/vsh/openpipeline/v4.1.0/nextflow/dimred/umap/main.nf"
umap_cpu = umap_cpu_viashalias.run(key: "umap_cpu")
