...
meta = [
  ...
  "argument_groups" : [
    {
      ...
      "arguments" : [
        ...
        },
        {
          "type" : "string",
          "name" : "--input_layer",
          "description" : "Input layer to use. By default, X is scaled.",
          "required" : false,
          "direction" : "input",
          "multiple" : false,
          "multiple_sep" : ";"
      ...
      "arguments" : [
        {
          "type" : "boolean",
          "name" : "--zero_center",
          "description" : "If True, center the data to zero mean before scaling. If False,\nomit zero-centering, which preserves sparsity.\n",
          "default" : [
            true
          ],
          "required" : false,
        ...
        },
        {
          "type" : "double",
          "name" : "--max_value",
          "description" : "Clip (truncate) values to this maximum after scaling. By default,\nvalues are not clipped.\n",
          "required" : false,
          "direction" : "input",
          "multiple" : false,
          "multiple_sep" : ";"
  ...
  "description" : "Scale data to unit variance and (optionally) zero mean, running either the\nGPU (rapids-singlecell) or the CPU (scanpy) variant of scale, selected\nwith --device_type.\n",
  "test_resources" : [
    {
      "type" : "nextflow_script",
      "path" : "test.nf",
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_rapids/openpipeline_rapids/src/wrappers/preprocessing/scale/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
...
include { scale as scale_gpu_viashalias } from "${meta.resources_dir}/../../../../../nextflow/preprocessing/scale/main.nf"
scale_gpu = scale_gpu_viashalias.run(key: "scale_gpu")
include { scale as scale_cpu_viashalias } from "${meta.root_dir}/dependencies/vsh/vsh/openpipeline/v4.1.0/nextflow/transform/scale/main.nf"
scale_cpu = scale_cpu_viashalias.run(key: "scale_cpu")
