...
meta = [
      ...
      "arguments" : [
        {
          "type" : "file",
          "name" : "--input",
          "description" : "Input h5mu file. When running the GPU variant (`--device_type gpu`), genes\nwith zero expression must be filtered out beforehand (e.g. with\n`filter_genes`), as rapids-singlecell PCA raises an error otherwise.\nThe CPU variant tolerates zero-expression genes.\n",
          "example" : [
            "input.h5mu"
          ],
          "must_exist" : true,
  ...
  "description" : "Computes PCA coordinates, loadings and variance decomposition, running either\nthe GPU (rapids-singlecell) or the CPU (scanpy) variant of pca, selected\nwith --device_type.\n",
  "test_resources" : [
    {
      "type" : "nextflow_script",
      "path" : "test.nf",
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_rapids/openpipeline_rapids/src/wrappers/preprocessing/pca/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
...
include { pca as pca_gpu_viashalias } from "${meta.resources_dir}/../../../../../nextflow/preprocessing/pca/main.nf"
pca_gpu = pca_gpu_viashalias.run(key: "pca_gpu")
include { pca as pca_cpu_viashalias } from "${meta.root_dir}/dependencies/vsh/vsh/openpipeline/v4.1.0/nextflow/dimred/pca/main.nf"
pca_cpu = pca_cpu_viashalias.run(key: "pca_cpu")
