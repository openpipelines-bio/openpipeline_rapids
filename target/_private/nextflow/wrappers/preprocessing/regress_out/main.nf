...
meta = [
  ...
  "argument_groups" : [
    {
      ...
      "arguments" : [
        ...
        },
        {
          "type" : "string",
          "name" : "--obs_keys",
          "description" : "Keys of the .obs columns to regress out as covariates.\n",
          "required" : true,
          "direction" : "input",
          "multiple" : true,
          "multiple_sep" : ","
      ...
      "arguments" : [
        {
          "type" : "integer",
          "name" : "--batchsize",
          "description" : "Number of genes per batch. If None, all genes are processed at once.\n",
          "required" : false,
          "direction" : "input",
          "multiple" : false,
          "multiple_sep" : ";"
  ...
  "description" : "Regress out (mostly) unwanted sources of variation, running either the GPU\n(rapids-singlecell) or the CPU (scanpy) variant of regress_out,\nselected with --device_type.\n",
  "test_resources" : [
    {
      "type" : "nextflow_script",
      "path" : "test.nf",
  ...
  "dependencies" : [
    {
      "name" : "preprocessing/regress_out",
      "alias" : "regress_out_gpu",
      "repository" : {
        "type" : "local"
      }
    },
    {
      "name" : "transform/regress_out",
      "alias" : "regress_out_cpu",
      "repository" : {
        "type" : "vsh",
        "repo" : "openpipeline",
        "tag" : "v4.1.0"
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_rapids/openpipeline_rapids/src/wrappers/preprocessing/regress_out/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
...
include { regress_out as regress_out_gpu_viashalias } from "${meta.resources_dir}/../../../../../nextflow/preprocessing/regress_out/main.nf"
regress_out_gpu = regress_out_gpu_viashalias.run(key: "regress_out_gpu")
include { regress_out as regress_out_cpu_viashalias } from "${meta.root_dir}/dependencies/vsh/vsh/openpipeline/v4.1.0/nextflow/transform/regress_out/main.nf"
regress_out_cpu = regress_out_cpu_viashalias.run(key: "regress_out_cpu")
