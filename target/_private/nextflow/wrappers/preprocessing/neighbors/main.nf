...
meta = [
    ...
    },
    {
      ...
      "arguments" : [
        ...
        },
        {
          "type" : "string",
          "name" : "--metric",
          "description" : "The distance metric to use. Restricted to the metrics supported by\nboth the CPU (scanpy) and GPU (rapids-singlecell) backends, so the\nvalue is valid regardless of --device_type. Each backend supports\nfurther metrics on its own, but only this common set is exposed here\nto keep the two variants interchangeable.\n",
          "default" : [
            "euclidean"
          ],
          "required" : false,
      ...
      "arguments" : [
        {
          "type" : "integer",
          "name" : "--n_pcs",
          "description" : "Number of dimensions of the `--obsm_input` representation to use. If\nnot set, all available dimensions are used.\n",
          "required" : false,
          "direction" : "input",
          "multiple" : false,
          "multiple_sep" : ";"
        ...
        },
        {
          "type" : "string",
          "name" : "--method",
          "description" : "Method for computing connectivities. 'umap' uses\nthe UMAP fuzzy simplicial set, 'gauss' uses an adaptive Gaussian\nkernel, 'jaccard' uses the PhenoGraph Jaccard index.\n",
          "default" : [
            "umap"
          ],
          "required" : false,
  ...
  "description" : "Compute a nearest-neighbor graph of observations, running either the GPU\n(rapids-singlecell) or the CPU (scanpy) variant of neighbors, selected\nwith --device_type.\n",
  "test_resources" : [
    {
      "type" : "nextflow_script",
      "path" : "test.nf",
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_rapids/openpipeline_rapids/src/wrappers/preprocessing/neighbors/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
    "output" : "/home/runner/work/openpipeline_rapids/openpipeline_rapids/target/_private/nextflow/wrappers/preprocessing/neighbors",
    "viash_version" : "0.9.7",
...
include { neighbors as neighbors_gpu_viashalias } from "${meta.resources_dir}/../../../../../nextflow/preprocessing/neighbors/main.nf"
neighbors_gpu = neighbors_gpu_viashalias.run(key: "neighbors_gpu")
include { find_neighbors as neighbors_cpu_viashalias } from "${meta.root_dir}/dependencies/vsh/vsh/openpipeline/v4.1.0/nextflow/neighbors/find_neighbors/main.nf"
neighbors_cpu = neighbors_cpu_viashalias.run(key: "neighbors_cpu")
