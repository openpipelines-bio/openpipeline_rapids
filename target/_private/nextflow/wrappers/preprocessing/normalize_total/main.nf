...
meta = [
      ...
      "arguments" : [
        {
          "type" : "integer",
          "name" : "--target_sum",
          "description" : "If not set, after normalization each observation (cell) has a total\ncount equal to the median of total counts for observations (cells)\nbefore normalization.\n",
          "required" : false,
          "min" : 1,
          "direction" : "input",
          "multiple" : false,
  ...
  "description" : "Normalize counts per cell, running either the GPU (rapids-singlecell) or the\nCPU (scanpy) variant of normalize_total, selected with --device_type.\n",
  "test_resources" : [
    {
      "type" : "nextflow_script",
      "path" : "test.nf",
  ...
  "dependencies" : [
    {
      "name" : "preprocessing/normalize_total",
      "alias" : "normalize_total_gpu",
      "repository" : {
        "type" : "local"
      }
    },
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_rapids/openpipeline_rapids/src/wrappers/preprocessing/normalize_total/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
    "output" : "/home/runner/work/openpipeline_rapids/openpipeline_rapids/target/_private/nextflow/wrappers/preprocessing/normalize_total",
    "viash_version" : "0.9.7",
...
include { normalize_total as normalize_total_gpu_viashalias } from "${meta.resources_dir}/../../../../../nextflow/preprocessing/normalize_total/main.nf"
normalize_total_gpu = normalize_total_gpu_viashalias.run(key: "normalize_total_gpu")
include { normalize_total as normalize_total_cpu_viashalias } from "${meta.root_dir}/dependencies/vsh/vsh/openpipeline/v4.1.0/nextflow/transform/normalize_total/main.nf"
normalize_total_cpu = normalize_total_cpu_viashalias.run(key: "normalize_total_cpu")
