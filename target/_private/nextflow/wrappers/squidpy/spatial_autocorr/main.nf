...
meta = [
  ...
  "argument_groups" : [
    {
      ...
      "arguments" : [
        ...
        },
        {
          "type" : "string",
          "name" : "--layer",
          "description" : "Layer in the modality to use for the autocorrelation analysis.\nIf unset, .X is used.\n",
          "required" : false,
          "direction" : "input",
          "multiple" : false,
          "multiple_sep" : ";"
        ...
        },
        {
          "type" : "string",
          "name" : "--input_genes",
          "description" : "Subset of genes (from .var_names) to compute autocorrelation for.\nIf unset, highly variable genes (if annotated) or all genes are used.\n",
          "required" : false,
          "direction" : "input",
          "multiple" : true,
          "multiple_sep" : ","
      ...
      "arguments" : [
        {
          "type" : "string",
          "name" : "--mode",
          "description" : "Spatial autocorrelation statistic to compute. 'moran' for Moran's I,\n'geary' for Geary's C.\n",
          "default" : [
            "moran"
          ],
          "required" : false,
        ...
        },
        {
          "type" : "integer",
          "name" : "--n_perms",
          "description" : "Number of permutations for the permutation-based p-value calculation.\nIf unset, only analytical p-values are computed.\n",
          "required" : false,
          "min" : 1,
          "direction" : "input",
          "multiple" : false,
    ...
    },
    {
      ...
      "arguments" : [
        ...
        },
        {
          "type" : "boolean_true",
          "name" : "--two_tailed",
          "description" : "If set, compute two-tailed p-values from the permutation test instead\nof one-tailed.\n",
          "direction" : "input"
        },
        {
          "type" : "string",
          "name" : "--corr_method",
          "description" : "Multiple-testing correction method to apply to p-values (any method\nsupported by statsmodels multipletests, e.g. 'fdr_bh', 'bonferroni').\nPass an empty string to disable correction.\n",
          "default" : [
            "fdr_bh"
          ],
          "required" : false,
      ...
      "arguments" : [
        {
          "type" : "boolean",
          "name" : "--use_all_genes",
          "description" : "Use all genes even if highly variable genes are annotated in .var.\n",
          "default" : [
            false
          ],
          "required" : false,
        ...
        },
        {
          "type" : "string",
          "name" : "--attr",
          "description" : "Which AnnData attribute --input_genes refers to (X uses .var_names,\nobs uses .obs columns, obsm uses indices in .obsm[layer]).\n",
          "default" : [
            "X"
          ],
          "required" : false,
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_rapids/openpipeline_rapids/src/wrappers/squidpy/spatial_autocorr/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
    ...
    "viash_version" : "0.9.7",
    "git_commit" : "a280075332c44ea0f4ca58a6812ed207ef24294c",
...
include { spatial_autocorr as spatial_autocorr_gpu_viashalias } from "${meta.resources_dir}/../../../../../nextflow/squidpy/spatial_autocorr/main.nf"
spatial_autocorr_gpu = spatial_autocorr_gpu_viashalias.run(key: "spatial_autocorr_gpu")
include { spatial_autocorr as spatial_autocorr_cpu_viashalias } from "${meta.root_dir}/dependencies/vsh/vsh/openpipeline_spatial/v0.5.0/nextflow/feature_annotation/spatial_autocorr/main.nf"
spatial_autocorr_cpu = spatial_autocorr_cpu_viashalias.run(key: "spatial_autocorr_cpu")
