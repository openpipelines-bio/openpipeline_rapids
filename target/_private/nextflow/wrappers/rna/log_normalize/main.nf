...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_rapids/openpipeline_rapids/src/wrappers/rna/log_normalize/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
    "output" : "/home/runner/work/openpipeline_rapids/openpipeline_rapids/target/_private/nextflow/wrappers/rna/log_normalize",
    "viash_version" : "0.9.7",
...
include { log_normalize as log_normalize_gpu_viashalias } from "${meta.resources_dir}/../../../../../nextflow/workflows/rna/log_normalize/main.nf"
log_normalize_gpu = log_normalize_gpu_viashalias.run(key: "log_normalize_gpu")
include { log_normalize as log_normalize_cpu_viashalias } from "${meta.root_dir}/dependencies/vsh/vsh/openpipeline/v4.1.0/_private/nextflow/workflows/rna/log_normalize/main.nf"
log_normalize_cpu = log_normalize_cpu_viashalias.run(key: "log_normalize_cpu")
