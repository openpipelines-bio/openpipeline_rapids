// spatial_autocorr build_fix_umap_skip_gpu_transfer
// 
...
meta = [
  ...
  "namespace" : "squidpy",
  "version" : "build_fix_umap_skip_gpu_transfer",
  "authors" : [
    {
      "name" : "Jakub Majercik",
      "roles" : [
    ...
    },
    {
      ...
      "arguments" : [
        ...
        },
        {
          "type" : "integer",
          "name" : "--n_perms",
          "description" : "Number of permutations for the permutation-based p-value\ncalculation. If unset, only analytical p-values are computed.\n",
          "required" : false,
          "min" : 1,
          "direction" : "input",
          "multiple" : false,
        ...
        },
        {
          "type" : "boolean_true",
          "name" : "--two_tailed",
          "description" : "If set, compute two-tailed p-values from the permutation test\ninstead of one-tailed.\n",
          "direction" : "input"
        },
        {
          "type" : "string",
          "name" : "--corr_method",
          "description" : "Multiple-testing correction method to apply to p-values. Any method\nsupported by `statsmodels.stats.multitest.multipletests`, e.g.\n'fdr_bh', 'fdr_by', 'bonferroni', 'holm'. Pass an empty string to\ndisable correction.\n",
          "default" : [
            "fdr_bh"
          ],
          "required" : false,
        ...
        },
        {
          "type" : "boolean",
          "name" : "--use_sparse",
          "description" : "If true, use a sparse representation of the expression matrix on\nthe GPU.\n",
          "default" : [
            true
          ],
          "required" : false,
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_rapids/openpipeline_rapids/src/squidpy/spatial_autocorr/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "/home/runner/work/openpipeline_rapids/openpipeline_rapids/target/nextflow/squidpy/spatial_autocorr",
    "viash_version" : "0.9.7",
    "git_commit" : "43612ed3a1491782e272d97e1442ed6f1abdb1b8",
...
par = {
  ...
  'transformation': $( if [ ! -z ${VIASH_PAR_TRANSFORMATION+x} ]; then echo "r'${VIASH_PAR_TRANSFORMATION//\\'/\\'\\"\\'\\"r\\'}'.lower() == 'true'"; else echo None; fi ),
  'two_tailed': $( if [ ! -z ${VIASH_PAR_TWO_TAILED+x} ]; then echo "r'${VIASH_PAR_TWO_TAILED//\\'/\\'\\"\\'\\"r\\'}'.lower() == 'true'"; else echo None; fi ),
  'corr_method': $( if [ ! -z ${VIASH_PAR_CORR_METHOD+x} ]; then echo "r'${VIASH_PAR_CORR_METHOD//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'use_sparse': $( if [ ! -z ${VIASH_PAR_USE_SPARSE+x} ]; then echo "r'${VIASH_PAR_USE_SPARSE//\\'/\\'\\"\\'\\"r\\'}'.lower() == 'true'"; else echo None; fi )
}
meta = {
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline_rapids/squidpy/spatial_autocorr",
    "tag" : "build_fix_umap_skip_gpu_transfer"
  },
  "label" : [
    "midmem",
    "lowcpu",
