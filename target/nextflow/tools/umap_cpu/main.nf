// umap_cpu build_benchmark_gpu_vs_cpu_workflows
// 
...
meta = [
  ...
  "description" : "CPU (scanpy) counterpart of the GPU `tools/umap` component, mirroring the\nOpenPipeline `dimred/umap` implementation. It exists purely so the UMAP step\ncan be timed CPU-vs-GPU on the same input: it emits the same \\"Computing UMAP\\"\nand \\"Writing\\" log lines as the GPU component, so the wall-clock between them is\ndirectly comparable.\n\nUMAP (Uniform Manifold Approximation and Projection) is a manifold learning\ntechnique for visualizing high-dimensional data. It optimizes the\nlow-dimensional embedding so that it best reflects the topology of the data,\nas represented by a precomputed neighborhood graph (e.g. from the\n`find_neighbors` component). See McInnes et al. (2018), arXiv:1802.03426.\n",
  "test_resources" : [
    {
      "type" : "python_script",
      "path" : "test.py",
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_rapids/openpipeline_rapids/src/tools/umap_cpu/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "/home/runner/work/openpipeline_rapids/openpipeline_rapids/target/nextflow/tools/umap_cpu",
    "viash_version" : "0.9.7",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline_rapids/tools/umap_cpu",
