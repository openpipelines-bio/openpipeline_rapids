// leiden build_fix_umap_skip_gpu_transfer
// 
...
meta = [
      ...
      "arguments" : [
        {
          "type" : "double",
          "name" : "--resolution",
          "description" : "A parameter value controlling the coarseness of the clustering.\nHigher values lead to more clusters. Multiple values will result\nin clustering being performed multiple times.\n",
          "default" : [
            1.0
          ],
          "required" : true,
        ...
        },
        {
          "type" : "integer",
          "name" : "--n_iterations",
          "description" : "Maximum number of iterations/levels of the Leiden algorithm. The\nalgorithm will terminate after no more than this many iterations.\n",
          "default" : [
            100
          ],
          "required" : false,
        ...
        },
        {
          "type" : "double",
          "name" : "--theta",
          "description" : "Scales modularity gain in the Leiden refinement phase, used to\ncompute the probability of joining a random Leiden community.\n",
          "default" : [
            1.0
          ],
          "required" : false,
        ...
        },
        {
          "type" : "integer",
          "name" : "--random_state",
          "description" : "Random seed to initialise the optimization. Use this to increase\nreproducibility.\n",
          "default" : [
            0
          ],
          "required" : false,
  ...
  "description" : "Cluster cells using the Leiden algorithm, the GPU-accelerated\nrapids-singlecell implementation built on cuGraph. Leiden is an improved\nversion of the Louvain algorithm. Requires a precomputed neighbor graph\n(e.g. from the `find_neighbors` component).\n",
  "test_resources" : [
    {
      "type" : "python_script",
      "path" : "test.py",
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_rapids/openpipeline_rapids/src/tools/leiden/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
par = {
  ...
  'theta': $( if [ ! -z ${VIASH_PAR_THETA+x} ]; then echo "float(r'${VIASH_PAR_THETA//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  'random_state': $( if [ ! -z ${VIASH_PAR_RANDOM_STATE+x} ]; then echo "int(r'${VIASH_PAR_RANDOM_STATE//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  'use_weights': $( if [ ! -z ${VIASH_PAR_USE_WEIGHTS+x} ]; then echo "r'${VIASH_PAR_USE_WEIGHTS//\\'/\\'\\"\\'\\"r\\'}'.lower() == 'true'"; else echo None; fi )
}
meta = {
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline_rapids/tools/leiden",
