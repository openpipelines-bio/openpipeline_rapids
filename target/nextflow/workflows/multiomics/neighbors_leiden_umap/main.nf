// neighbors_leiden_umap build_harmony_leiden_benchmark
// 
...
meta = [
  ...
  "description" : "Performs neighborhood search, Leiden clustering and UMAP on an integrated embedding.",
  "test_resources" : [
    {
      "type" : "nextflow_script",
      "path" : "test.nf",
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_rapids/openpipeline_rapids/src/workflows/multiomics/neighbors_leiden_umap/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
    "output" : "/home/runner/work/openpipeline_rapids/openpipeline_rapids/target/nextflow/workflows/multiomics/neighbors_leiden_umap",
    "viash_version" : "0.9.7",
...
include { neighbors } from "${meta.resources_dir}/../../../../nextflow/preprocessing/neighbors/main.nf"
include { leiden } from "${meta.resources_dir}/../../../../nextflow/tools/leiden/main.nf"
include { umap } from "${meta.resources_dir}/../../../../nextflow/tools/umap/main.nf"
include { move_obsm_to_obs } from "${meta.root_dir}/dependencies/vsh/vsh/openpipeline/v4.1.0/nextflow/metadata/move_obsm_to_obs/main.nf"
