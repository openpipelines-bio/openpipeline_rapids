// harmony_leiden build_harmony_leiden_benchmark
// 
...
meta = [
    ...
    },
    {
      ...
      "arguments" : [
        ...
        },
        {
          "type" : "double",
          "name" : "--theta",
          "description" : "Diversity clustering penalty parameter. Can be set as a single value for all batch observations or as\nmultiple values, one for each observation in the batches defined by --obs_covariates. theta=0 does not\nencourage any diversity. Larger values of theta result in more diverse clusters.\n",
          "default" : [
            2.0
          ],
          "required" : false,
  ...
  "description" : "Run GPU Harmony integration followed by neighbour calculations, leiden clustering and umap on the result.",
  "status" : "enabled",
  "scope" : {
    "image" : "public",
    "target" : "public"
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_rapids/openpipeline_rapids/src/workflows/integration/harmony_leiden/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
    "output" : "/home/runner/work/openpipeline_rapids/openpipeline_rapids/target/nextflow/workflows/integration/harmony_leiden",
    "viash_version" : "0.9.7",
...
include { harmony_integrate } from "${meta.resources_dir}/../../../../nextflow/preprocessing/harmony_integrate/main.nf"
