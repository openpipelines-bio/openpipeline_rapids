// log_normalize build_harmony_leiden_benchmark
// 
...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_rapids/openpipeline_rapids/src/workflows/rna/log_normalize/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
...
include { normalize_total } from "${meta.resources_dir}/../../../../nextflow/preprocessing/normalize_total/main.nf"
include { log1p } from "${meta.resources_dir}/../../../../nextflow/preprocessing/log1p/main.nf"
include { delete_layer } from "${meta.root_dir}/dependencies/vsh/vsh/openpipeline/v4.1.0/nextflow/transform/delete_layer/main.nf"
