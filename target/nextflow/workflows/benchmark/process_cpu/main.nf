// process_cpu build_benchmark_gpu_vs_cpu_workflows
// 
...
meta = [
      ...
      "arguments" : [
        {
          "type" : "file",
          "name" : "--input",
          "description" : "Path to the input H5MU file (spatial data with raw counts).",
          "example" : [
            "dataset.h5mu"
          ],
          "must_exist" : true,
  ...
  "description" : "CPU counterpart of workflows/benchmark/process_gpu. Chains the equivalent\nOpenPipeline CPU components into the same pipeline so the total runtime can be\ncompared 1:1 against the GPU rapids-singlecell stack on the same input.\n\nThis workflow is not meant to produce meaningful biological results; it\nexercises every component end to end.\n\nChain:\n  log_normalize           (normalize_total + log1p)\n    -> highly_variable_features_scanpy\n    -> pca                  (.obsm[\\"X_pca\\"])\n    -> neighbors_leiden_umap (find_neighbors + leiden + umap)\n    -> spatial_autocorr     (Moran's I)\n\nThe input must already contain a spatial neighbourhood graph in\n.obsp[\\"spatial_connectivities\\"] for the spatial_autocorr step.\n",
  "test_resources" : [
    {
      "type" : "nextflow_script",
      "path" : "test.nf",
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_rapids/openpipeline_rapids/src/workflows/benchmark/process_cpu/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
...
include { log_normalize } from "${meta.root_dir}/dependencies/vsh/vsh/openpipeline/v4.1.0/_private/nextflow/workflows/rna/log_normalize/main.nf"
include { highly_variable_features_scanpy } from "${meta.root_dir}/dependencies/vsh/vsh/openpipeline/v4.1.0/nextflow/feature_annotation/highly_variable_features_scanpy/main.nf"
include { pca } from "${meta.root_dir}/dependencies/vsh/vsh/openpipeline/v4.1.0/nextflow/dimred/pca/main.nf"
...
include { spatial_autocorr } from "${meta.root_dir}/dependencies/vsh/vsh/openpipeline_spatial/v0.5.0/nextflow/feature_annotation/spatial_autocorr/main.nf"
