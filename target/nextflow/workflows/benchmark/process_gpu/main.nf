// process_gpu build_benchmark_gpu_vs_cpu_workflows
// 
...
meta = [
  ...
  "description" : "Bulk benchmark pipeline chaining every GPU rapids-singlecell component in\nthis repository into a single run. Intended for timing the full stack on a\nGPU compute environment (e.g. Seqera Platform) and comparing the runtime to\nthe equivalent CPU pipeline (workflows/benchmark/process_cpu).\n\nThis workflow is not meant to produce meaningful biological results; it\nexercises every component end to end.\n\nChain:\n  log_normalize           (normalize_total + log1p)\n    -> highly_variable_genes\n    -> pca                  (.obsm[\\"X_pca\\"])\n    -> neighbors_leiden_umap (neighbors + leiden + umap)\n    -> spatial_autocorr     (Moran's I)\n\nThe input must already contain a spatial neighbourhood graph in\n.obsp[\\"spatial_connectivities\\"] for the spatial_autocorr step.\n",
  "test_resources" : [
    {
      "type" : "nextflow_script",
      "path" : "test.nf",
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_rapids/openpipeline_rapids/src/workflows/benchmark/process_gpu/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
    "output" : "/home/runner/work/openpipeline_rapids/openpipeline_rapids/target/nextflow/workflows/benchmark/process_gpu",
    "viash_version" : "0.9.7",
...
include { log_normalize } from "${meta.resources_dir}/../../../../nextflow/workflows/rna/log_normalize/main.nf"
include { highly_variable_genes } from "${meta.resources_dir}/../../../../nextflow/preprocessing/highly_variable_genes/main.nf"
include { pca } from "${meta.resources_dir}/../../../../nextflow/preprocessing/pca/main.nf"
include { neighbors_leiden_umap } from "${meta.resources_dir}/../../../../nextflow/workflows/multiomics/neighbors_leiden_umap/main.nf"
include { spatial_autocorr } from "${meta.resources_dir}/../../../../nextflow/squidpy/spatial_autocorr/main.nf"
