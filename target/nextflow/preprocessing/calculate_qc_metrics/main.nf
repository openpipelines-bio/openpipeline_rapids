// calculate_qc_metrics build_harmony_leiden_benchmark
// 
...
meta = [
  ...
  "argument_groups" : [
    {
      ...
      "arguments" : [
        ...
        },
        {
          "type" : "string",
          "name" : "--layer",
          "description" : "Layer to compute QC metrics from. By default, X is used.\n",
          "required" : false,
          "direction" : "input",
          "multiple" : false,
          "multiple_sep" : ";"
        },
        {
          "type" : "string",
          "name" : "--qc_vars",
          "description" : "Names of boolean columns in .var for which per-cell percentage\nmetrics are computed (e.g. \\"mito\\" to compute pct_counts_mito).\n",
          "required" : false,
          "direction" : "input",
          "multiple" : true,
          "multiple_sep" : ","
      ...
      "arguments" : [
        {
          "type" : "string",
          "name" : "--expr_type",
          "description" : "Name of the expression unit, used to build the metric keys.",
          "default" : [
            "counts"
          ],
          "required" : false,
        ...
        },
        {
          "type" : "string",
          "name" : "--var_type",
          "description" : "Name of the variable type, used to build the metric keys.",
          "default" : [
            "genes"
          ],
          "required" : false,
        ...
        },
        {
          "type" : "boolean",
          "name" : "--log1p",
          "description" : "Also compute log1p-transformed quality control metrics.",
          "default" : [
            true
          ],
          "required" : false,
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_rapids/openpipeline_rapids/src/preprocessing/calculate_qc_metrics/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
par = {
  ...
  'qc_vars': $( if [ ! -z ${VIASH_PAR_QC_VARS+x} ]; then echo "r'${VIASH_PAR_QC_VARS//\\'/\\'\\"\\'\\"r\\'}'.split(',')"; else echo None; fi ),
  'output': $( if [ ! -z ${VIASH_PAR_OUTPUT+x} ]; then echo "r'${VIASH_PAR_OUTPUT//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'output_compression': $( if [ ! -z ${VIASH_PAR_OUTPUT_COMPRESSION+x} ]; then echo "r'${VIASH_PAR_OUTPUT_COMPRESSION//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'expr_type': $( if [ ! -z ${VIASH_PAR_EXPR_TYPE+x} ]; then echo "r'${VIASH_PAR_EXPR_TYPE//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'var_type': $( if [ ! -z ${VIASH_PAR_VAR_TYPE+x} ]; then echo "r'${VIASH_PAR_VAR_TYPE//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'log1p': $( if [ ! -z ${VIASH_PAR_LOG1P+x} ]; then echo "r'${VIASH_PAR_LOG1P//\\'/\\'\\"\\'\\"r\\'}'.lower() == 'true'"; else echo None; fi )
}
meta = {
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline_rapids/preprocessing/calculate_qc_metrics",
