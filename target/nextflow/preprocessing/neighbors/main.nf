// neighbors build_fix_umap_skip_gpu_transfer
// 
...
meta = [
    ...
    },
    {
      ...
      "arguments" : [
        ...
        },
        {
          "type" : "string",
          "name" : "--method",
          "description" : "Method for computing connectivities. 'umap' uses the UMAP fuzzy\nsimplicial set, 'gauss' uses an adaptive Gaussian kernel, 'jaccard'\nuses the PhenoGraph Jaccard index.\n",
          "default" : [
            "umap"
          ],
          "required" : false,
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_rapids/openpipeline_rapids/src/preprocessing/neighbors/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline_rapids/preprocessing/neighbors",
