// bbknn build_harmony_leiden_benchmark
// 
...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_rapids/openpipeline_rapids/src/preprocessing/bbknn/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "/home/runner/work/openpipeline_rapids/openpipeline_rapids/target/nextflow/preprocessing/bbknn",
    "viash_version" : "0.9.7",
...
par = {
  ...
  'trim': $( if [ ! -z ${VIASH_PAR_TRIM+x} ]; then echo "int(r'${VIASH_PAR_TRIM//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline_rapids/preprocessing/bbknn",
