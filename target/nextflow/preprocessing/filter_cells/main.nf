// filter_cells build_harmony_leiden_benchmark
// 
...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_rapids/openpipeline_rapids/src/preprocessing/filter_cells/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "/home/runner/work/openpipeline_rapids/openpipeline_rapids/target/nextflow/preprocessing/filter_cells",
    "viash_version" : "0.9.7",
...
par = {
  ...
  'max_genes': $( if [ ! -z ${VIASH_PAR_MAX_GENES+x} ]; then echo "int(r'${VIASH_PAR_MAX_GENES//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi )
}
meta = {
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline_rapids/preprocessing/filter_cells",
