// filter_genes build_harmony_leiden_benchmark
// 
...
meta = [
  ...
  "argument_groups" : [
    {
      ...
      "arguments" : [
        ...
        },
        {
          "type" : "string",
          "name" : "--layer",
          "description" : "Layer of counts to filter on. If not set, .X is used.\n",
          "required" : false,
          "direction" : "input",
          "multiple" : false,
          "multiple_sep" : ";"
    ...
    },
    {
      ...
      "arguments" : [
        ...
        },
        {
          "type" : "integer",
          "name" : "--min_cells",
          "description" : "Minimum number of cells expressing a gene required for it to pass\nfiltering.\n",
          "required" : false,
          "min" : 0,
          "direction" : "input",
          "multiple" : false,
        ...
        },
        {
          "type" : "integer",
          "name" : "--max_counts",
          "description" : "Maximum number of counts allowed for a gene to pass filtering.\n",
          "required" : false,
          "min" : 0,
          "direction" : "input",
          "multiple" : false,
        ...
        },
        {
          "type" : "integer",
          "name" : "--max_cells",
          "description" : "Maximum number of cells expressing a gene allowed for it to pass\nfiltering.\n",
          "required" : false,
          "min" : 0,
          "direction" : "input",
          "multiple" : false,
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_rapids/openpipeline_rapids/src/preprocessing/filter_genes/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline_rapids/preprocessing/filter_genes",
