// highly_variable_genes build_fix_umap_skip_gpu_transfer
// 
...
meta = [
    ...
    },
    {
      ...
      "arguments" : [
        ...
        },
        {
          "type" : "integer",
          "name" : "--chunksize",
          "description" : "If flavor is 'poisson_gene_selection', this determines how many\ngenes are processed at once. Choosing a smaller value will reduce\nthe required memory.\n",
          "default" : [
            1000
          ],
          "required" : false,
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_rapids/openpipeline_rapids/src/preprocessing/highly_variable_genes/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
par = {
  ...
  'theta': $( if [ ! -z ${VIASH_PAR_THETA+x} ]; then echo "int(r'${VIASH_PAR_THETA//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  'clip': $( if [ ! -z ${VIASH_PAR_CLIP+x} ]; then echo "float(r'${VIASH_PAR_CLIP//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  'chunksize': $( if [ ! -z ${VIASH_PAR_CHUNKSIZE+x} ]; then echo "int(r'${VIASH_PAR_CHUNKSIZE//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  'n_samples': $( if [ ! -z ${VIASH_PAR_N_SAMPLES+x} ]; then echo "int(r'${VIASH_PAR_N_SAMPLES//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  'obs_batch_key': $( if [ ! -z ${VIASH_PAR_OBS_BATCH_KEY+x} ]; then echo "r'${VIASH_PAR_OBS_BATCH_KEY//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'check_values': $( if [ ! -z ${VIASH_PAR_CHECK_VALUES+x} ]; then echo "r'${VIASH_PAR_CHECK_VALUES//\\'/\\'\\"\\'\\"r\\'}'.lower() == 'true'"; else echo None; fi )
}
meta = {
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline_rapids/preprocessing/highly_variable_genes",
