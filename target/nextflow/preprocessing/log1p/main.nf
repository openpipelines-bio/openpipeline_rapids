// log1p build_fix_umap_skip_gpu_transfer
// 
...
meta = [
    ...
    },
    {
      ...
      "arguments" : [
        ...
        },
        {
          "type" : "string",
          "name" : "--output_obsm",
          "description" : "Output entry in .obsm to write the transformed matrix to. Only\nvalid when --input_obsm is set. If not set, the input .obsm entry\nis modified in-place. Mutually exclusive with --output_layer.\n",
          "required" : false,
          "direction" : "input",
          "multiple" : false,
          "multiple_sep" : ";"
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_rapids/openpipeline_rapids/src/preprocessing/log1p/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
par = {
  ...
  'input_obsm': $( if [ ! -z ${VIASH_PAR_INPUT_OBSM+x} ]; then echo "r'${VIASH_PAR_INPUT_OBSM//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'output': $( if [ ! -z ${VIASH_PAR_OUTPUT+x} ]; then echo "r'${VIASH_PAR_OUTPUT//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'output_layer': $( if [ ! -z ${VIASH_PAR_OUTPUT_LAYER+x} ]; then echo "r'${VIASH_PAR_OUTPUT_LAYER//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'output_obsm': $( if [ ! -z ${VIASH_PAR_OUTPUT_OBSM+x} ]; then echo "r'${VIASH_PAR_OUTPUT_OBSM//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline_rapids/preprocessing/log1p",
