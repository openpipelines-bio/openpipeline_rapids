// regress_out build_harmony_leiden_benchmark
// 
...
meta = [
  ...
  "description" : "Regress out (mostly) unwanted sources of variation.\n\nUses simple linear regression. This is a GPU-accelerated wrapper around\nrapids_singlecell.pp.regress_out, taking the listed .obs columns as\ncovariates to regress out of the expression matrix.\n",
  "test_resources" : [
    {
      "type" : "python_script",
      "path" : "test.py",
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_rapids/openpipeline_rapids/src/preprocessing/regress_out/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
par = {
  ...
  'batchsize': $( if [ ! -z ${VIASH_PAR_BATCHSIZE+x} ]; then echo "int(r'${VIASH_PAR_BATCHSIZE//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi )
}
meta = {
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline_rapids/preprocessing/regress_out",
