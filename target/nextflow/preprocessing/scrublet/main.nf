// scrublet build_harmony_leiden_benchmark
// 
...
meta = [
  ...
  "argument_groups" : [
    {
      ...
      "arguments" : [
        ...
        },
        {
          "type" : "string",
          "name" : "--layer",
          "description" : "Layer of raw counts to run doublet detection on. If not set, `.X`\nis used.\n",
          "required" : false,
          "direction" : "input",
          "multiple" : false,
          "multiple_sep" : ";"
        },
        {
          "type" : "string",
          "name" : "--batch_key",
          "description" : "An optional `.obs` column with batch information. If set, Scrublet is\nrun independently for each batch and the doublet scores are stitched\nback together.\n",
          "required" : false,
          "direction" : "input",
          "multiple" : false,
          "multiple_sep" : ";"
    ...
    },
    {
      ...
      "arguments" : [
        ...
        },
        {
          ...
          "description" : "The estimated doublet rate for the experiment.\n",
          "default" : [
            0.05
          ],
          "required" : false,
        ...
        },
        {
          "type" : "integer",
          "name" : "--n_neighbors",
          "description" : "Number of neighbors used to construct the KNN graph of observed and\nsimulated transcriptomes. If not set, this is automatically set to\nround(0.5 * sqrt(n_obs)).\n",
          "required" : false,
          "min" : 1,
          "direction" : "input",
          "multiple" : false,
        ...
        },
        {
          "type" : "double",
          "name" : "--threshold",
          "description" : "Doublet score threshold for calling a transcriptome a doublet. If not\nset, this is set automatically by looking for the minimum between the\ntwo modes of the doublet_scores_sim_ histogram.\n",
          "required" : false,
          "min" : 0.0,
          "max" : 1.0,
          "direction" : "input",
  ...
  "description" : "Predict doublets using Scrublet.\n\nComputes a doublet score for each cell from a raw count matrix by simulating\ndoublets and comparing each observed transcriptome to the simulated ones.\nWraps the rapids-singlecell `rsc.pp.scrublet` function. Results are written to\n`.obs[\\"doublet_score\\"]`, `.obs[\\"predicted_doublet\\"]`, and `.uns[\\"scrublet\\"]`.\n",
  "test_resources" : [
    {
      "type" : "python_script",
      "path" : "test.py",
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_rapids/openpipeline_rapids/src/preprocessing/scrublet/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "/home/runner/work/openpipeline_rapids/openpipeline_rapids/target/nextflow/preprocessing/scrublet",
    "viash_version" : "0.9.7",
...
par = {
  ...
  'n_prin_comps': $( if [ ! -z ${VIASH_PAR_N_PRIN_COMPS+x} ]; then echo "int(r'${VIASH_PAR_N_PRIN_COMPS//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  'n_neighbors': $( if [ ! -z ${VIASH_PAR_N_NEIGHBORS+x} ]; then echo "int(r'${VIASH_PAR_N_NEIGHBORS//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  'threshold': $( if [ ! -z ${VIASH_PAR_THRESHOLD+x} ]; then echo "float(r'${VIASH_PAR_THRESHOLD//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline_rapids/preprocessing/scrublet",
