// normalize_total build_fix_umap_skip_gpu_transfer
// 
...
meta = [
    ...
    },
    {
      ...
      "arguments" : [
        ...
        },
        {
          ...
          "description" : "Exclude (very) highly expressed genes for the computation of the\nnormalization factor (size factor) for each cell. A gene is\nconsidered highly expressed if it has more than max_fraction of\nthe total counts in at least one cell. The not-excluded genes\nwill sum up to target_sum.\n",
          "direction" : "input"
        },
        {
          "type" : "double",
          "name" : "--max_fraction",
          "description" : "If exclude_highly_expressed=True, consider cells as highly\nexpressed that have more counts than max_fraction of the original\ntotal counts in at least one cell.\n",
          "default" : [
            0.05
          ],
          "required" : false,
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_rapids/openpipeline_rapids/src/preprocessing/normalize_total/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline_rapids/preprocessing/normalize_total",
